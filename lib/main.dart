...
class FormApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const FormPage(title: 'Flutter Form'),
    );
  }
}
          ...
          Navigator.push(
              ...
              MaterialPageRoute(
                ...
                //alamat.text adalah paramter yang dikirim
                  builder: (_) => detail(name: name.text, email: email.text, gender:gender, status: _maritalStatus, terms: _termsChecked.toString(),)
              )
          );
        }
      },
